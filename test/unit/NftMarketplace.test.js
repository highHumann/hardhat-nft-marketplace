    ...
    : describe("Nft Marketplace Unit Tests", function () {
          ...
          describe("listItem", function () {
              ...
              it("reverts if the price be 0", async () => {
                  ...
                  ).revertedWith("NftMarketplace_PriceMustBeAboveZer0")
              })
          })
          ...
          describe("updateListing", function () {
              ...
              it("reverts if new price is 0", async function () {
                  ...
                  await expect(
                      nftMarketplace.listItem(basicNft.address, TOKEN_ID, updatedPrice)
                  ).to.be.revertedWith("NftMarketplace_PriceMustBeAboveZer0")
              })
